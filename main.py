...
FILE_PATH = "D:\\Python files\\file.txt"
...
def add_password():
    ...
    if not is_password_valid:
        print("Invalid Password Format ! "
              "Atleast 1 Upper, lower, digit & special cases should be there"
...
def user_opt():
    to_continue = True
    while to_continue:
        print (''' Please select any one option no :
               1. Login 
               2. Register 
               3. Exit ''')
        user_input = input("Choose :")
